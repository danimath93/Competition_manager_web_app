...
const CategoryExecution = () => {
      ...
      <Container maxWidth="xl" sx={{ mt: 4, mb: 4 }}>
        ...
        <Alert severity="error">
          ...
          <Typography variant="body2">
            Non hai i permessi necessari per accedere allo svolgimento delle categorie di questa competizione.
  ...
  return (
    <Container maxWidth="xl" sx={{ mt: 4, mb: 4 }}>
      ...
      <Paper sx={{ p: 3 }}>
        <Alert severity="info">
          La funzionalità di svolgimento gara è in fase di sviluppo.
          Qui sarà possibile gestire l'esecuzione delle categorie durante la competizione.
        </Alert>
      </Paper>
    </Container>
  );
